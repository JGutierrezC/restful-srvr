module RestfulSrvr::API
  module GenericServer
    ...
    module ClassMethods
      ...
      #   are testing the application. Start the entire application with {RestfulSrvr::API::Application.run}
      def start(*args)
      ...
      #   the application. Stop the entire application with {RestfulSrvr::API::Application.shutdown}
      def stop
