...
module RestfulSrvr::API
  class RESTGateway < Reel::Server::HTTP
    extend Forwardable
    include RestfulSrvr::API::GenericServer
    ...
    PROTO_RACK_ENV = {
      ...
      SERVER_SOFTWARE   => "RestfulSrvr-api/#{RestfulSrvr::API::VERSION}".freeze,
    ...
    # @return [RestfulSrvr::API::RackApp]
    attr_reader :app
    ...
    def initialize(options = {})
      ...
      @app = RestfulSrvr::API::RackApp.new
    end
